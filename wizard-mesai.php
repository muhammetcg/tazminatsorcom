...
<head>
  ...
  <title>Tazminatsor | Fazla Çalışma</title>
    ...
    <div class="tab-content needs-validation">
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input id="startDate" class="form-control wizard-input input-lg" type="date" name="date" value="" />
              <label for="endDate">Çıkış</label>
              <input id="endDate" class="form-control wizard-input input-lg" type="date" name="date" value="" />
            </div>
          </div>
        </div>
        <button type="button" class="btn btn-info next" onclick="mesaiStep1()">
          İleri
        </button>
      </div>
      <div class="tab-pane" id="step2">
        <div class="well">
          ...
          <button type="button" class="btn btn-info next" onclick="mesaiStep2()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <!-- <br/> -->
              <div class="done">
                <label class="form-label">Haftalık Çalışma Saatiniz?:</label>
              </div>
              <input class="form-control wizard-input input-lg" type="text" value="" placeholder="Haftalık Mesai"
                id="inputNumberSecond" />
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
            Geri
          </button>
          <button type="button" class="btn btn-info next" onclick="mesaiStep3()">
            İleri
          </button>
        </div>
      </div>
            ...
            <div class="col-md-12 form-required">
              <div class="formbold-main-wrapper">
                ...
                <div class="formbold-form-wrapper">
                  ...
                  <form method="POST" action="form-post.php" id="form-mesai">
                    ...
                    <div class="formbold-mb-5 formType">
                      <input id="formType" type="hidden" name="formType" value="Fazla Çalışma Tazminatı">
                    </div>
