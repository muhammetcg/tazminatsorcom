...
<head>
  ...
  <title>Tazminatsor | İş Kazası</title>
    ...
    <div class="tab-content needs-validation">
      <div class="tab-pane" id="step1">
        <div class="well">
          ...
          <button type="button" class="btn btn-info next" onclick="handleWorkGenderButton()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step2">
        <div class="well">
          <div class="row g-3">
            <!-- <br /> -->
            <div class="done">
              <label class="form-label" for="form-label year-input"
                style="display: block; margin-bottom: 1.5em">Yaşınız:</label>
            </div>
          ...
          <button type="button" class="btn btn-info next" onclick="handleWorkBornButton()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              <!-- <br /> -->
              <div class="done">
                <label class="form-label" style="display: block; margin-bottom: 1.5em">Net Maaşınız:</label>
              </div>
          ...
          <button type="button" class="btn btn-info next" onclick="handleWorkPriceStep()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step4">
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input class="form-control wizard-input input-lg disability" type="number" id="input-number-1" value=""
                  min="1" max="100" placeholder="Sakatlık Oranı" />
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next" onclick="handleWorkDisabilityButton()">
            İleri
          </button>
        </div>
      </div>
            ...
            <div class="col-md-12 form-required">
              <div class="formbold-main-wrapper">
                ...
                <div class="formbold-form-wrapper">
                  ...
                  <form method="POST" action="form-post.php" id="form-is">
                    ...
                    <div class="formbold-mb-5 formType">
                      <input id="formType" type="hidden" name="formType" value="İş Kazası Tazminatı">
                    </div>
        ...
        <div class="footer-container head_container container">
          <div class="row">
            ...
            <div class="footer-social col">
              ...
              <a href=""><i class="bi bi-phone"></i>&nbsp +90 850 242 45 35
              </a>
            </div>
          </div>
        </div>
