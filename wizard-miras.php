...
<body>
  ...
  <div class="container" id="myWizard">
    <div class="progress">
      <div class="progress-bar bg-info" role="progressbar" aria-valuenow="1" aria-valuemin="1" aria-valuemax="6"
        style="width: 20%">
        <!-- Adım 1 - 10 -->
      </div>
    </div>
    ...
    <div class="tab-content needs-validation">
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              <!-- <br /> -->
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakan Tarafından Hazırlanan Bir Vasiyetname Var
                  mı?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepOne" name="options-outlined " id="success-outlined"
                  autocomplete="off" value="Var" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-outlined">Var</label>

                <input type="radio" class="btn-check mirasStepOne" name="options-outlined " id="success-2-outlined"
                  autocomplete="off" value="Yok" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-2-outlined">Yok</label>
              </div>
            </div>
          </div>
        </div>
        <button type="button" class="btn btn-info next" onclick="mirasStep1()">
          İleri
        </button>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Eşi Yaşıyor mu?
                </label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepTwo" name="options-outlined" id="success-3-outlined"
                  autocomplete="off" value="Evet" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-3-outlined">Evet</label>
                <input type="radio" class="btn-check mirasStepTwo" name="options-outlined" id="success-4-outlined"
                  autocomplete="off" value="Hayır" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-4-outlined">Hayır</label>
              </div>
            </div>
          </div>
          ...
          <button type="button" class="btn btn-info next" onclick="mirasStep2()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step3">
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6 stepContainer">
              <!-- <br /> -->
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Çocuğu Var mı?
                </label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepThree" name="options-outlined" id="success-5-outlined"
                  autocomplete="off" value="Var" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-5-outlined">Var</label>
                <input type="radio" class="btn-check mirasStepThree" name="options-outlined" id="success-6-outlined"
                  autocomplete="off" value="Yok" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-6-outlined">Yok</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next nextExtr">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Annesi Yaşıyor Mu?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepFourth" name="options-outlined" id="success-7-outlined"
                  autocomplete="off" value="Evet" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-7-outlined">Evet</label>
                <input type="radio" class="btn-check mirasStepFourth" name="options-outlined" id="success-8-outlined"
                  autocomplete="off" value="Hayır" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-8-outlined">Hayır</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next" onclick="mirasStep4()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Babası Yaşıyor Mu?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepFifth" name="options-outlined" id="success-9-outlined"
                  autocomplete="off" value="Evet" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-9-outlined">Evet</label>
                <input type="radio" class="btn-check mirasStepFifth" name="options-outlined" id="success-10-outlined"
                  autocomplete="off" value="Hayır" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-10-outlined">Hayır</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next nextExtrSecond" onclick="mirasStep5()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step6">
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6 stepContainer2">
              <!-- <br /> -->
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Kardeşleri Var Mı?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepSixth" name="options-outlined" id="success-11-outlined"
                  autocomplete="off" value="Var" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-11-outlined">Var</label>
                <input type="radio" class="btn-check mirasStepSixth" name="options-outlined" id="success-12-outlined"
                  autocomplete="off" value="Yok" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-12-outlined">Yok</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next nextExtrThird" onclick="mirasStep6()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Büyükbabası Yaşıyor Mu?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepSeventh" name="options-outlined" id="success-13-outlined"
                  autocomplete="off" value="Evet" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-13-outlined">Evet</label>
                <input type="radio" class="btn-check mirasStepSeventh" name="options-outlined" id="success-14-outlined"
                  autocomplete="off" value="Hayır" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-14-outlined">Hayır</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next" onclick="mirasStep7()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Büyükannesi Yaşıyor Mu?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepEighth" name="options-outlined" id="success-15-outlined"
                  autocomplete="off" value="Evet" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-15-outlined">Evet</label>
                <input type="radio" class="btn-check mirasStepEighth" name="options-outlined" id="success-16-outlined"
                  autocomplete="off" value="Hayır" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-16-outlined">Hayır</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next nextExtrFourth" onclick="mirasStep8()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step9">
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6 stepContainer3">
              <!-- <br /> -->
              <div class="done">
                <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                <label class="form-label">Miras Bırakanın Toplamda Amca, Hala, Dayı ve Teyze Yaşıyor
                  Mu?</label>
              </div>
              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input type="radio" class="btn-check mirasStepNinth" name="options-outlined" id="success-17-outlined"
                  autocomplete="off" value="Evet" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-17-outlined">Evet</label>
                <input type="radio" class="btn-check mirasStepNinth" name="options-outlined" id="success-18-outlined"
                  autocomplete="off" value="Hayır" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-18-outlined">Hayır</label>
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next" onclick="mirasStep9()">
            İleri
          </button>
        </div>
      </div>
            ...
            <div class="col-md-12 form-required">
              <div class="formbold-main-wrapper">
                ...
                <div class="formbold-form-wrapper">
                  ...
                  <form method="POST" action="form-post.php" id="form-miras">
                    ...
                    <div class="formbold-mb-5 formType">
                      <input id="formType" type="hidden" name="formType" value="Miras Payı Hesaplama">
                    </div>

                    <select class="form-select formbold-form-input formbold-mb-5" name="city"
      ...
      <div class="tab-pane" id="stepLast">
        <div class="well">
          <div class="row g-3 d-flex" style="flex-direction: column; align-items: center">
            <div class="result-tab col-md-4 mx-auto">
              <h2 class="form-label result-form d-flex justify-content-center pt-3"
                style="margin-top: 0.5rem; text-align: center">
                Yasal Mirasçıların Kişi Başına Düşen Miras Payı
              </h2>
              <hr class="mx-auto" style="width: 70%; color: #78cce3; opacity: 100" />
              <h2 id="sonuc" class="form-label result-form d-flex justify-content-center pt-2"
                style="font-size: 2.5rem">
                &#37;{{Result}}
              </h2>

              <h2 class="form-label result-form d-flex justify-content-center pt-5"
                style="margin-top: 0.5rem; text-align: center">
                Varsa Eş Payı
              </h2>
              <hr class="mx-auto" style="width: 70%; color: #78cce3; opacity: 100" />
              <h2 id="sonuc2" class="form-label result-form d-flex justify-content-center pt-2"
                style="font-size: 2.5rem">
                &#37;{{esPayi}}
              </h2>
            ...
            <div class="row g-3">
              ...
              >
                ...
                <label
                  ...
                  style="display: block; margin-bottom: 1.5em; width: 100%"
                  >Yasal Mirasçıların Kişi Başına Düşen Miras Payı:</label
                >
                <label
                  id="sonuc"
                  class="form-label"
  ...
  <div class="content-contact">
    <div class="container">
      <div class="contact-text" style="margin: 2em 0">
        ...
        <a href="tel:(0212)7060134" class="phone"><i class="bi bi-phone"></i>&nbsp; (0212) 706 0 134</a>
      </div>
    </div>
  </div>
  <hr />
        ...
        <div class="footer-container head_container container">
          <div class="row">
            ...
            <div class="footer-social col">
              ...
              <a href=""><i class="bi bi-phone"></i>&nbsp (0212) 706 0 134
              </a>
            </div>
          </div>
        </div>
