...
<head>
  ...
  <title>Tazminatsor | Trafik Kazası</title>
      ...
      <div class="tab-pane" id="step1">
        <div class="well">
          <div class="row g-3">
            <!-- <br /> -->
            <div class="done">
              <label class="form-label" style="display: block; margin-bottom: 1.5em">Trafik Kazası Sonucu Yaşadığınız
                Mağduriyet;</label>
            </div>
            <div class="col-md-12 wizard-btn-check">
              <input type="radio" class="btn-check status" name="options-outlined " id="success-outlined"
                autocomplete="off" value="Ölümlü" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-outlined">Ölümlü</label>

              <input type="radio" class="btn-check status" name="options-outlined " id="success-2-outlined"
                autocomplete="off" value="Yaralanmalı" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-2-outlined">Yaralanmalı</label>
            </div>
          </div>
        </div>
        <button type="button" class="btn btn-info next" onclick="handleStatusButton()">
          İleri
        </button>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              <!-- <br /> -->
              <div class="done">
                <label class="form-label" style="display: block; margin-bottom: 1.5em">Cinsiyet:</label>
              </div>

              <div class="col-md-12 wizard-btn-check">
                <input type="radio" class="btn-check gender" name="options-outlined" value="Erkek"
                  id="success-12-outlined" autocomplete="off" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-12-outlined">Erkek</label>

                <input type="radio" class="btn-check gender" name="options-outlined" value="Kadın"
                  id="success-13-outlined" autocomplete="off" required />
                <label class="btn btn-check-wizard btn-outline-success" for="success-13-outlined">Kadın</label>
              </div>
            </div>
          </div>
          ...
          <button type="button" class="btn btn-info next" onclick="handleGenderButton()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step3">
        <div class="well">
          <div class="row g-3">
            <!-- <br /> -->
            <div class="done">
              <label class="form-label" for="form-label year-input" style="display: block; margin-bottom: 1.5em"
                id="caption-change">Yaşınız:</label>
            </div>
            <div class="col-md-12 wizard-btn-check" id="error-message">
              <input type="text" class="form-control wizard-input input-lg" id="year-input" name="year" required />
            </div>
          </div>
          ...
          <button type="button" class="btn btn-info next" onclick="handleBornButton()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              <!-- <br /> -->
              <div class="done">
                <label class="form-label" style="display: block; margin-bottom: 1.5em">Son Aldığınız Net
                  Maaşınız:</label>
              </div>
              <input class="form-control" type="text" value="" placeholder="Net Maaşınızı Giriniz." id="maasInput" />
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
            Geri
          </button>
          <button type="button" class="btn btn-info next" onclick="handlePriceStep()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="step5">
        <div class="well">
          <div class="row g-3">
            <!-- <br /> -->
            <div class="done">
              <label class="form-label" style="display: block; margin-bottom: 1.5em">Kusur Oranınız?:</label>
            </div>
            <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
              <input type="radio" class="btn-check kusurOrani" name="options-outlined" id="success-6-outlined"
                autocomplete="off" value="0" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-6-outlined">%0</label>

              <input type="radio" class="btn-check kusurOrani" name="options-outlined" id="success-7-outlined"
                autocomplete="off" value="25" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-7-outlined">%25</label>

              <input type="radio" class="btn-check kusurOrani" name="options-outlined" id="success-8-outlined"
                autocomplete="off" value="50" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-8-outlined">%50</label>

              <input type="radio" class="btn-check kusurOrani" name="options-outlined" id="success-9-outlined"
                autocomplete="off" value="75" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-9-outlined">%75</label>

              <input type="radio" class="btn-check kusurOrani" name="options-outlined" id="success-10-outlined"
                autocomplete="off" value="100" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-10-outlined">%100</label>

              <input type="radio" class="btn-check kusurOrani" name="options-outlined" id="success-11-outlined"
                autocomplete="off" value="0" required />
              <label class="btn btn-check-wizard btn-outline-success" for="success-11-outlined">Bilmiyorum</label>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
            Geri
          </button>
          <button type="button" class="btn btn-info next" onclick="handleKusurOraniRadioButtons()">
            İleri
          </button>
        </div>
      </div>
      <div class="tab-pane" id="disability6">
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              <div class="done">
                <label class="form-label" style="display: block; margin-bottom: 1.5em">Sakatlık oranınız:</label>
              </div>

              <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                <input class="form-control wizard-input input-lg disability" type="number" value="" min="1" max="100"
                  placeholder="Sakatlık Oranı" />
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
          ...
          <button type="button" class="btn btn-info next" onclick="handleDisabilityButton()">
            İleri
          </button>
        </div>
      </div>
        ...
        <div class="well">
          <div class="row g-3">
            <div class="col-md-6">
              <!-- <br /> -->
              <div class="done">
                <label class="form-label" style="display: block">Maddi kaybınız:</label>
              </div>
              <span style="font-style: italic">Eğer Maddi Kaybınız bulunmuyorsa, bu adıma 0 (sıfır) yazarak
                ilerleyebilirsiniz.</span>
              <input class="form-control wizard-input input-lg" type="text" value=""
                placeholder="Maddi kaybınızı giriniz." id="maddiKayip" />
            </div>
          </div>
          <button type="button" class="btn btn-info prev backButton">
            Geri
          </button>
          <button type="button" class="btn btn-info next" onclick="handleLossSelect()">
            İleri
          </button>
        </div>
      </div>
            ...
            <div class="col-md-12 form-required">
              <div class="formbold-main-wrapper">
                ...
                <div class="formbold-form-wrapper">
                  ...
                  <form method="POST" action="form-post.php" id="form-trafik">
                    ...
                    <div class="formbold-mb-5 formType">
                      <input id="formType" type="hidden" name="formType" value="Trafik Kazası Tazminatı">
                    </div>
              ...
              <div class="row g-3">
                <div class="col-md-12">
                  <div class="formbold-main-wrapper">
                    <div class="formbold-form-wrapper">
                      <form
                        action="https://formspree.io/f/meqwkbvn"
                        method="POST"
                      >
                        <div class="formbold-mb-5">
                        ...
                        <button
                          ...
                          onclick="handleGeriButton()"
                        >
                          Geri
                        </button>
                        <button
                          type="submit"
                          class="btn btn-success first next"
                          onclick=""
                        >
                          Gönder ve Sonucu Gör
                        </button>
