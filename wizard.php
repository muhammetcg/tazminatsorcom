...
<head>
  ...
  <title>Tazminatsor | Değer Kaybı</title>
...
<body>
  ...
  <!-- <button type="button" class="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#myModal1"
    id="triggerBtn1"></button>
  <button type="button" class="btn btn-primary d-none" data-bs-toggle="modal" data-bs-target="#myModal2"
    id="triggerBtn2"></button> -->
    ...
    <div class="container" id="myWizard">
      <div class="progress">
        <div class="progress-bar bg-info step-counter" role="progressbar" aria-valuenow="1" aria-valuemin="1"
          aria-valuemax="6" style="width: 20%"></div>
      </div>
          ...
          <div class="well">
            <div class="row g-3">
              <div class="col-md-6">
                <!-- <br/> -->
                <div class="done">
                  <label class="form-label">Aracınızın ortalama piyasa değerini girin</label>
                </div>
                <input class="form-control wizard-input input-lg" type="text" value="" placeholder="Araç Piyasa Değeri"
                  id="firstStepInput" />
              </div>
            </div>
          </div>
          <button type="button" class="btn btn-info next" onclick="saveStep1()">
            İleri
          </button>
        </div>
        <div class="tab-pane">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <div class="done">
                  ...
                  <label class="form-label">Aracınızın kilometre bilgisini girin</label>
                </div>
                <input class="form-control wizard-input input-lg" type="text" value=""
                  placeholder="Araç Kilometre Bilgisi" id="secondStepInput" />
              </div>
            </div>
            <button type="button" class="btn btn-info prev backButton">
              Geri
            </button>
            <button type="button" class="btn btn-info next" onclick="saveStep2()">
              İleri
            </button>
          </div>
        </div>
          ...
          <div class="well">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <div class="done">
                  <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                  <label class="form-label">Aracınızdaki hasar (tramer) değerini girin</label>
                </div>
                <input class="form-control wizard-input input-lg" type="text" value="" placeholder="Hasar değeri"
                  id="thirdStepInput" />
              </div>
            </div>
            <button type="button" class="btn btn-info prev backButton">
            ...
            <button type="button" class="btn btn-info next" onclick="saveStep3()">
              İleri
            </button>
          </div>
        </div>
          ...
          <div class="well">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <div class="done">
                  <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                  <label class="form-label">Kaza tarihinin üzerinden</label>
                </div>
                <div class="col-md-12 wizard-btn-check">
                  <input type="radio" class="btn-check" name="options-outlined" id="success-outlined" autocomplete="off"
                    value="" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-outlined">2 yıl geçmedi</label>

                  <input type="radio" class="btn-check" name="options-outlined" id="danger-outlined" autocomplete="off"
                    value="" required />
                  <label class="btn btn-check-wizard btn-outline-danger" for="danger-outlined">2 yıl geçti</label>
                </div>
              </div>
            </div>
            <button type="button" class="btn btn-info prev backButton">
            ...
            <button type="button" class="btn btn-info next">İleri</button>
          </div>
        </div>
        <div class="tab-pane">
          <div class="well">
            <div class="row g-3">
              <div class="col-md-6">
                <div class="done">
                  <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                  <label class="form-label">Kusur oranınız</label>
                </div>

                <div class="col-md-12 wizard-btn-check" style="margin-top: 1em">
                  <input type="radio" class="btn-check" name="options-outlined" id="success-2-outlined"
                    autocomplete="off" value="%0" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-2-outlined">%0</label>

                  <input type="radio" class="btn-check" name="options-outlined" id="success-3-outlined"
                    autocomplete="off" value="%25" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-3-outlined">%25</label>

                  <input type="radio" class="btn-check" name="options-outlined" id="success-4-outlined"
                    autocomplete="off" value="%50" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-4-outlined">%50</label>

                  <input type="radio" class="btn-check" name="options-outlined" id="success-5-outlined"
                    autocomplete="off" value="%75" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-5-outlined">%75</label>

                  <input type="radio" class="btn-check" name="options-outlined" id="success-6-outlined"
                    autocomplete="off" value="%100" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-6-outlined">%100</label>

                  <input type="radio" class="btn-check" name="options-outlined" id="success-7-outlined"
                    autocomplete="off" value="" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-7-outlined">Bilmiyorum</label>
                </div>
              </div>
            </div>
            <button type="button" class="btn btn-info prev backButton">
            ...
            <button type="button" class="btn btn-info next" onclick="saveStep5()">
              İleri
            </button>
          </div>
        </div>
          ...
          <div class="well">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <div class="done">
                  <!-- <i class="bi bi-arrow-left-short prev"></i> -->
                  <label class="form-label">Kaza tarihinden önce aracınızın ağır hasar kaydı var
                    mı?</label>
                </div>
                <div class="col-md-12 wizard-btn-check">
                  <input type="radio" class="btn-check" name="options-outlined" value="Var" id="success-8-outlined"
                    autocomplete="off" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-8-outlined">Var</label>

                  <input type="radio" class="btn-check" name="options-outlined" value="Yok" id="success-9-outlined"
                    autocomplete="off" required />
                  <label class="btn btn-check-wizard btn-outline-success" for="success-9-outlined">Yok</label>
                </div>
              </div>
            </div>
            <button type="button" class="btn btn-info prev backButton">
            ...
            <button type="button" class="btn btn-info next" onclick="saveStep6()">
              İleri
            </button>
          </div>
        </div>
                  ...
                  <div class="formbold-form-wrapper">
                    <div class="col-md-12 justify-content-center d-flex">
                      <h5 class="main-forum-title" style="text-align: center">
                        Çok az kaldı, hesaplamanı görebilmen için son bir
                        adım!
                      </h5>
                    </div>
                    <form method="POST" action="form-post.php" id="form-deger">
                      ...
                      <div class="formbold-mb-5 formType">
                        <input id="formType" type="hidden" name="formType" value="Değer Kaybı Tazminatı">
                      </div>
          ...
          <div class="well">
            <div class="row g-3 d-flex" style="flex-direction: column; align-items: center">
              ...
              <p class="col-md-4 d-flex" style="text-align: center; font-size: 9px; color: red">
                Tazminatsor.com hesaplama sonucu kesin ve nihai rakam
                olmamakla beraber, yargılama aşamasında farklılık
                gösterebilmektedir.*
              </p>
            </div>
          </div>
  ...
  <div class="content-contact">
    <div class="container">
      <div class="contact-text" style="margin: 2em 0">
        ...
        <a href="tel:(0212) 706 0 134" class="phone"><i class="bi bi-phone"></i>&nbsp; (0212) 706 0 134</a>
      </div>
    </div>
  </div>
  <hr />
